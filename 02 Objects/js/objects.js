...
console.log("Value:", order.discount); // undefined
...
function showOrder(order) {
    ...
    console.log("this in function scope:", this); // window object
}
...
let pr1 = new Product("iPhone X", 1400);
let pr2 = new Product("iPhone Y", 1099);
let pr3 = new Product("iPhone S", 1300);
